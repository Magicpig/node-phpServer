...
var errorPage = require('../../../errorPage/errorPage.js').errorPage;
// prototype
 ...
 * @api public
 */
function setErrorPage(status,message){
   pageUrl =''
}
...
//        if ('test' != env) console.error(err.stack || err.toString());
        ...
        if (err.status!=undefined&&err.status!=''){
            errorPage.showPage(err.status,msg,req,res);
            return;
        }
       ...
       //console.log('404parse');
        errorPage.showPage(404,msg,req,res);
        return;
